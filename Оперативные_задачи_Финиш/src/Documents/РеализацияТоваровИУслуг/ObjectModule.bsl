Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Иначе
		...
		Запрос.Текст = "ВЫБРАТЬ
			...
			|////////////////////////////////////////////////////////////////////////////////
			|ВЫБРАТЬ
			|	СебестоимостьТоваровПоПартиямОстатки.Номенклатура,
			|	СебестоимостьТоваровПоПартиямОстатки.Партия,
			|	СебестоимостьТоваровПоПартиямОстатки.КоличествоОстаток,
			|	СебестоимостьТоваровПоПартиямОстатки.СебестоимостьОстаток
